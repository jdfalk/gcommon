...
const file_commonpb_v2_partition_strategy_proto_rawDesc = "" +
	...
	" PARTITION_STRATEGY_LOAD_BALANCED\x10\x06B\xaa\x01\n" +
	"\rcom.common.v2B\x16PartitionStrategyProtoP\x01Z4github.com/falkcorp/gcommon/pkg/commonpb/v2;commonv2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
