...
const file_commonpb_v2_comparison_operator_proto_rawDesc = "" +
	...
	"&COMPARISON_OPERATOR_LESS_THAN_OR_EQUAL\x10\x06B\xab\x01\n" +
	"\rcom.common.v2B\x17ComparisonOperatorProtoP\x01Z4github.com/falkcorp/gcommon/pkg/commonpb/v2;commonv2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
