// file: proto/gcommon/v2/common/health_admin_service.proto
// version: 1.0.1
...
func (UnimplementedHealthAdminServiceServer) ResetHealthStats(context.Context, *ResetHealthStatsRequest) (*ResetHealthStatsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetHealthStats not implemented")
}
func (UnimplementedHealthAdminServiceServer) SetHealth(context.Context, *SetHealthRequest) (*SetHealthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetHealth not implemented")
}
...
func RegisterHealthAdminServiceServer(s grpc.ServiceRegistrar, srv HealthAdminServiceServer) {
	// If the following call panics, it indicates UnimplementedHealthAdminServiceServer was
