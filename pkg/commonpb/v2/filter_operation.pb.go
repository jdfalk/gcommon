...
const file_commonpb_v2_filter_operation_proto_rawDesc = "" +
	...
	"\x12\x1b\n" +
	"\x17FILTER_OPERATION_NOT_IN\x10\vB\xa8\x01\n" +
	"\rcom.common.v2B\x14FilterOperationProtoP\x01Z4github.com/falkcorp/gcommon/pkg/commonpb/v2;commonv2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
