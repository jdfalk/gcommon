...
const file_commonpb_v2_run_check_response_proto_rawDesc = "" +
	...
	"\x05error\x18\a \x01(\v2\x10.common.v2.ErrorR\x05errorB\xa9\x01\n" +
	"\rcom.common.v2B\x15RunCheckResponseProtoP\x01Z4github.com/falkcorp/gcommon/pkg/commonpb/v2;commonv2\xa2\x02\x03CXX\xaa\x02\tCommon.V2\xca\x02\tCommon\\V2\xe2\x02\x15Common\\V2\\GPBMetadata\xea\x02\n" +
