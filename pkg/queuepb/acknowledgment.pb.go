...
const file_queuepb_v1_acknowledgment_proto_rawDesc = "" +
	...
	" \x01(\x05R\n" +
	"retryCountB\x93\x01\n" +
	"\fcom.queue.v1B\x13AcknowledgmentProtoP\x01Z%github.com/falkcorp/gcommon/pkg/queuepb\xa2\x02\x03QXX\xaa\x02\bQueue.V1\xca\x02\bQueue\\V1\xe2\x02\x14Queue\\V1\\GPBMetadata\xea\x02\tQueue::V1\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
