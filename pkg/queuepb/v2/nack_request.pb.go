...
const file_queuepb_v2_nack_request_proto_rawDesc = "" +
	...
	"maxRetries\x126\n" +
	"\bmetadata\x18d \x01(\v2\x1a.common.v2.RequestMetadataR\bmetadataB\xa0\x01\n" +
	"\fcom.queue.v2B\x10NackRequestProtoP\x01Z5github.com/falkcorp/gcommon/v2/pkg/queuepb/v2;queuev2\xa2\x02\x03QXX\xaa\x02\bQueue.V2\xca\x02\bQueue\\V2\xe2\x02\x14Queue\\V2\\GPBMetadata\xea\x02\tQueue::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"
