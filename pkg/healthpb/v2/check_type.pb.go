...
const file_healthpb_v2_check_type_proto_rawDesc = "" +
	...
	"\rcom.health.v2B\x0eCheckTypeProtoP\x01Z)github.com/falkcorp/gcommon/pkg/healthpb/v2\xa2\x02\x03HXX\xaa\x02\tHealth.V2\xca\x02\tHealth\\V2\xe2\x02\x15Health\\V2\\GPBMetadata\xea\x02\n" +
