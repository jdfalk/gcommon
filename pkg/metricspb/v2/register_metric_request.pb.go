...
const file_metricspb_v2_register_metric_request_proto_rawDesc = "" +
	...
	"\aoptions\x18\x05 \x01(\v2\x1f.metrics.v2.RegistrationOptionsR\aoptionsB\xb5\x01\n" +
	"\x0ecom.metrics.v2B\x1aRegisterMetricRequestProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
