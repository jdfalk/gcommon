...
const file_metricspb_v2_summary_config_proto_rawDesc = "" +
	...
	"timeWindow\x12 \n" +
	"\amax_age\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x06maxAgeB\xad\x01\n" +
	"\x0ecom.metrics.v2B\x12SummaryConfigProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
