...
const file_metricspb_v2_batch_context_proto_rawDesc = "" +
	...
	"\ais_last\x18\x04 \x01(\bR\x06isLastB\xac\x01\n" +
	"\x0ecom.metrics.v2B\x11BatchContextProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
