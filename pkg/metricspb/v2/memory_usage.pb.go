// file: proto/gcommon/v2/metrics/v2/memory_usage.proto
// version: 1.0.0
...
const file_metricspb_v2_memory_usage_proto_rawDesc = "" +
	...
	"\n" +
	"peak_bytes\x18\x04 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\tpeakBytesB\xae\x01\n" +
	"\x0ecom.metrics.v2B\x10MemoryUsageProtoP\x01Z9github.com/falkcorp/gcommon/v2/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
