...
// 	protoc        (unknown)
// source: metricspb/v2/unregistration_options.proto
...
func (x *UnregistrationOptions) Reset() {
	*x = UnregistrationOptions{}
	mi := &file_metricspb_v2_unregistration_options_proto_msgTypes[0]
...
var File_metricspb_v2_unregistration_options_proto protoreflect.FileDescriptor

const file_metricspb_v2_unregistration_options_proto_rawDesc = "" +
	"\n" +
	")metricspb/v2/unregistration_options.proto\x12\n" +
	...
	"\rcreate_backup\x18\b \x01(\bR\fcreateBackupB\xa9\x01\n" +
	"\x0ecom.metrics.v2B\x1aUnregistrationOptionsProtoP\x01Z*github.com/falkcorp/gcommon/pkg/metricspb/v2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
	"Metrics\\V2\xe2\x02\x16Metrics\\V2\\GPBMetadata\xea\x02\vMetrics::V2\x92\x03\x05\xd2>\x02\x10\x03b\beditionsp\xe8\a"

var file_metricspb_v2_unregistration_options_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_metricspb_v2_unregistration_options_proto_goTypes = []any{
	(*UnregistrationOptions)(nil), // 0: metrics.v2.UnregistrationOptions
}
var file_metricspb_v2_unregistration_options_proto_depIdxs = []int32{
...
func init() { file_metricspb_v2_unregistration_options_proto_init() }
func file_metricspb_v2_unregistration_options_proto_init() {
	if File_metricspb_v2_unregistration_options_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metricspb_v2_unregistration_options_proto_rawDesc), len(file_metricspb_v2_unregistration_options_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_metricspb_v2_unregistration_options_proto_goTypes,
		DependencyIndexes: file_metricspb_v2_unregistration_options_proto_depIdxs,
		MessageInfos:      file_metricspb_v2_unregistration_options_proto_msgTypes,
	}.Build()
	File_metricspb_v2_unregistration_options_proto = out.File
	file_metricspb_v2_unregistration_options_proto_goTypes = nil
	file_metricspb_v2_unregistration_options_proto_depIdxs = nil
}
