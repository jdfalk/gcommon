...
const file_metricspb_v2_register_metric_response_proto_rawDesc = "" +
	...
	" \x01(\bR\x10replacedExistingB\xb6\x01\n" +
	"\x0ecom.metrics.v2B\x1bRegisterMetricResponseProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
