...
const file_metricspb_v2_record_metric_request_proto_rawDesc = "" +
	...
	"\rbatch_context\x18\x06 \x01(\v2\x18.metrics.v2.BatchContextR\fbatchContextB\xb3\x01\n" +
	"\x0ecom.metrics.v2B\x18RecordMetricRequestProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
