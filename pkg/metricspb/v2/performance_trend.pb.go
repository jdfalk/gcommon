...
const file_metricspb_v2_performance_trend_proto_rawDesc = "" +
	...
	"\x10trend_confidence\x18\x03 \x01(\x01R\x0ftrendConfidenceB\xb0\x01\n" +
	"\x0ecom.metrics.v2B\x15PerformanceTrendProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
