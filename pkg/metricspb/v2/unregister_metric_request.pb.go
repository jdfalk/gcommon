...
const file_metricspb_v2_unregister_metric_request_proto_rawDesc = "" +
	...
	"\x11metric_identifierB\xb7\x01\n" +
	"\x0ecom.metrics.v2B\x1cUnregisterMetricRequestProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
