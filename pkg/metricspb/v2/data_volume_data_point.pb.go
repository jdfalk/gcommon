...
const file_metricspb_v2_data_volume_data_point_proto_rawDesc = "" +
	...
	"\x0eingestion_rate\x18\x05 \x01(\x01B\x0e\xbaH\v\x12\t)\x00\x00\x00\x00\x00\x00\x00\x00R\ringestionRateB\xb3\x01\n" +
	"\x0ecom.metrics.v2B\x18DataVolumeDataPointProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
