...
const file_metricspb_v2_resource_data_point_proto_rawDesc = "" +
	...
	"\x18network_bytes_per_second\x18\x05 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\x15networkBytesPerSecondB\xb1\x01\n" +
	"\x0ecom.metrics.v2B\x16ResourceDataPointProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
