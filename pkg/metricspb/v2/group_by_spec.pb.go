...
const file_metricspb_v2_group_by_spec_proto_rawDesc = "" +
	...
	"\n" +
	"max_groups\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\tmaxGroupsB\xab\x01\n" +
	"\x0ecom.metrics.v2B\x10GroupBySpecProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
