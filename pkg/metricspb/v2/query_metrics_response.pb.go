...
const file_metricspb_v2_query_metrics_response_proto_rawDesc = "" +
	...
	"\rtotal_results\x18\b \x01(\x03B\a\xbaH\x04\"\x02(\x00R\ftotalResultsB\xb4\x01\n" +
	"\x0ecom.metrics.v2B\x19QueryMetricsResponseProtoP\x01Z6github.com/falkcorp/gcommon/pkg/metricspb/v2;metricsv2\xa2\x02\x03MXX\xaa\x02\n" +
	"Metrics.V2\xca\x02\n" +
