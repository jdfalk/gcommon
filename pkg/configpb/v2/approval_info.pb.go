...
const file_configpb_v2_approval_info_proto_rawDesc = "" +
	...
	"policyNameB\x9a\x01\n" +
	"\rcom.config.v2B\x11ApprovalInfoProtoP\x01Z)github.com/falkcorp/gcommon/pkg/configpb/v2\xa2\x02\x03CXX\xaa\x02\tConfig.V2\xca\x02\tConfig\\V2\xe2\x02\x15Config\\V2\\GPBMetadata\xea\x02\n" +
